...
const reportStatuses: ReportStatus[] = ['Draft', 'Under Review', 'Approved', 'Denied', 'Closed'];
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-slate-600 mt-1">Review and manage incident reports</p>
      </div>
            ...
            return (
              ...
              >
                <div className="w-12 h-12 bg-slate-100 rounded-lg flex items-center justify-center mr-4">
                  <FileText className={`w-6 h-6 ${report.type === 'OSHA' ? 'text-blue-500' : 'text-orange-500'}`} />
                </div>
