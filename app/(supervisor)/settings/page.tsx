          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-slate-200 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 text-slate-900 placeholder:text-slate-700"
              />
            </div>
          </div>
        ...
        <div className="space-y-4">
          {[
            ...
            },
            {
              ...
              description: "Alerts when employee certifications are expiring",
            },
          ].map((item) => (
            <div
              key={item.key}
            ...
            >
              ...
              <button
                ...
                className={`relative w-12 h-6 rounded-full transition-colors ${
                  notifications[item.key] ? "bg-orange-500" : "bg-slate-300"
                }`}
              >
                <div
          ...
          <div>
            ...
            <div className="relative">
              ...
              <select
                ...
                aria-label="Theme"
                className="w-full pl-10 pr-4 py-2 border border-slate-200 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 appearance-none bg-white text-slate-900"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            ...
            <input
              ...
              placeholder="••••••••"
              className="w-full px-4 py-2 border border-slate-200 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 text-slate-900 placeholder:text-slate-700"
            />
          </div>
